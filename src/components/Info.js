...
export default function Info({ onRefresh, settings, onSettingsChange, onOpenHistory }) {
  ...
  return html`
    <div class="container" style="padding: 24px; padding-bottom: 100px; max-width: 1200px; margin: 0 auto;">
      ...
      <!-- INFO APP -->
      <div style="text-align: center; margin-top: 48px; color: var(--secondary-text-color); font-size: 12px; display: flex; flex-direction: column; align-items: center; gap: 8px;">
        ...
        <div style="display: flex; gap: 16px; align-items: center;">
            ...
            <a href="https://github.com/Babbone27/Manga-Box-Beta" target="_blank" rel="noopener noreferrer" style="color: var(--text-color); display: flex; align-items: center; gap: 4px; text-decoration: none; opacity: 0.8; transition: opacity 0.2s;" onMouseEnter=${e => e.currentTarget.style.opacity = '1'} onMouseLeave=${e => e.currentTarget.style.opacity = '0.8'}>
